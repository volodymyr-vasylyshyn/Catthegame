...
requiredVersions = {}
requiredVersions["atlas"] = 3.4
requiredVersions["map"] = 3.4
requiredVersions["tileLayer"] = 3.4
requiredVersions["objectLayer"] = 3.4
requiredVersions["tile"] = 3.4
requiredVersions["object"] = 3.4
requiredVersions["tileSet"] = 3.4
requiredVersions["property"] = 3.4
requiredVersions["utils"] = 3.4
